...
# MathOptFormat
dir1 = "/home/ak121396/Desktop/instances/FLP/data/"
...
NZ = (i+1)*j+(2*i*j)
objNZ = j+i+(i*j)
fname = ARGS[1][end-12:end-4]
ins = open("/home/k2g00/k2g3475/pastinstance/flp/vlp/"*"$fname"*".vlp", "a")
wholearray=[];

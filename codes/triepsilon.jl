...
mutable struct Laumanns
    ...
    function Laumanns()
        TimeLimit = 7200
        E = []; F = []; e = Dict(2=>[0,99999999],3=>[0,99999999]); fval = [];
...
#CSV.write("/home/k2g00/k2g3475/multiobjective/solvers/ep+FP/ep_results/ep_inf_"*"$ins"*"_record.csv",record1, append=true, writeheader=false)
CSV.write(ARGS[1]*"ep_demand_record.csv",record1 ,writeheader=false)

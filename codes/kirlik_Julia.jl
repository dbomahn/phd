...
cxx"""
        #include "./classes/include/Epsilon.h"
        ...
        Epsilon::Epsilon(int _p) {
                ...
                cplex.setOut(env.getNullStream());			//turn off output to the screen
        ...
        clock_t start = clock();
        void Epsilon::mainLoop(char* fileName, char* preND) {
                ...
                while (boxes.size() != liste.size()) {
                        ...
                        if (feas == true)	{
                                ...
                                check = checkEfficient(obj,preND);
                ...
                char *logf = new char[150];  //outputfile for writing #solved IPs
                logf = strcat(fileName,".log");
                ofstream logfile(logf, ofstream::out);
                logfile<< "IPs: " << counter <<endl;
                logfile<< "CPUtime(ms): " << time_elapsed << endl;
                logfile<< "CPUtime(sec): " << time_elapsed/1000.0 << endl;
                logfile.close();
...
cxx"""#include "./classes Epsilon.h"
        ...
        int main(int argc, char* argv[])  {
            ...
            //Call method
            epsilon.mainLoop(fileName,preND);

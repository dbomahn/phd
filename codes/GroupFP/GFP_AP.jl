using DelimitedFiles,DataFrames,JuMP,CPLEX,LinearAlgebra,CSV,Statistics,Clustering,CPUTime
global TimeLimit = 300
################################  Data  ####################################
struct ppath{S<:String}
    dir1::S; dir2::S; dir3::S
end
ppaths=ppath("/home/ak121396/Desktop/instances/AP/dat/",
    "/home/ak121396/Desktop/solvers/Bensolve/APoutputs/X/",
    "/home/ak121396/Desktop/solvers/Bensolve/APoutputs/Y/")
ppaths = ppath("E:/bensolve/ap/dat/","E:/bensolve/ap/X/","E:/bensolve/ap/Y/")
dir1 = ppaths.dir1; dir2 = ppaths.dir2; dir3 = ppaths.dir3
...
candX = [Vector(dv2[i, :]) for i = 1:size(L)[1]]
...
clu = kmeans(L',max(k,2)); nc = nclusters(clu);  SolPair = Set();
sc = counts(clu);
